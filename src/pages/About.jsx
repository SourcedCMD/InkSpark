  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">About NoteFlow</h1>

        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
            NoteFlow is a free, secure online notepad tool for taking notes, writing documents, saving ideas, and sharing content instantly.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            NoteFlow is built with modern web technologies:
          </p>
